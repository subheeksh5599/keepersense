...
export function runChecks() {
  ...
  const checks = [
    ...
    ['header logo', landingHtml.includes('Zen') && landingHtml.includes('ITH')],
  ...
  out.push(`${(pipeHtml.includes('Intent') && pipeHtml.includes('ITH') && pipeHtml.includes('pl-card')) ? 'PASS' : 'FAIL'} pipeline view renders`);
